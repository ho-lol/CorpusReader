...
class CategorizedTaggedCorpusReaderK(CategorizedCorpusReader,
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._raw_fileids=[fileid for fileid in self.fileids() if 'raw' in fileid]
        self._tagm_fileids=[fileid for fileid in self.fileids() if 'tagm' in fileid]
        self._morph_fileids=[fileid for fileid in self.fileids() if 'morph' in fileid]
    ...
    def words(self, fileids=None, categories=None,_sep=''):
        self._word_tokenizer=self._word_tokenizer
        return TaggedCorpusReader.words(
            self, self._resolve(self._raw_fileids, categories))
    ...
    def tagged_morphs(self, fileids=None, categories=None,_sep='/'):
    ...
    def tagged_words(self, fileids=None, categories=None, tagset=None,_sep=''):
        return TaggedCorpusReader.tagged_words(
            self, self._resolve(self._tagm_fileids, categories))
    def tagged_sents(self, fileids=None, categories=None, tagset=None,_sep='/'):
        self._word_tokenizer=self._tag_tokenizer
